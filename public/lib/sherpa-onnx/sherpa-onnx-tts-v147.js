if (typeof window !== 'undefined') {
  window.__SHERPA_TTS_BRIDGE_VERSION__ = "1.4.7";
  console.log("%c >>> SherpaONNX Bridge v1.4.7: THE REALIGNMENT <<< ", "background: #1a237e; color: #fff; font-size: 16px; font-weight: bold;");
}
...
class OfflineTts {
  ...
  generate(config) {
    ...
    try {
      ...
      console.log(`SherpaONNX v1.4.7: TRACE: Audio Handle ${h} -> ptr=${samplesPtr}, n=${numSamples}, rate=${sampleRate}`);
      ...
      console.error('SherpaONNX v1.4.7: Error reading generated audio:', e);
