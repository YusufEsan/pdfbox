(function() {
  if (typeof window !== 'undefined') {
    window.__SHERPA_TTS_BRIDGE_VERSION__ = "1.6.1";
    console.log("%c >>> SherpaONNX Bridge v1.6.1: TEXT HEALING ALIGNMENT <<< ", "background: #1e88e5; color: #fff; font-size: 16px; font-weight: bold;");
  }
