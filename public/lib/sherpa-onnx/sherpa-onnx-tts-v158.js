(function() {
  if (typeof window !== 'undefined') {
    window.__SHERPA_TTS_BRIDGE_VERSION__ = "1.5.8";
    console.log("%c >>> SherpaONNX Bridge v1.5.8: FS & MEMORY RESILIENCE <<< ", "background: #1e88e5; color: #fff; font-size: 16px; font-weight: bold;");
  }
  ...
  class OfflineTts {
    constructor(configObj, Module) {
      ...
      console.log("SherpaONNX: Calling _SherpaOnnxCreateOfflineTts...");
