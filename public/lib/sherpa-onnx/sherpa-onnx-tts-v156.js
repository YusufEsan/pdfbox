(function() {
  if (typeof window !== 'undefined') {
    window.__SHERPA_TTS_BRIDGE_VERSION__ = "1.5.6";
    console.log("%c >>> SherpaONNX Bridge v1.5.6: OFFICIAL MODEL LOADED <<< ", "background: #1e88e5; color: #fff; font-size: 16px; font-weight: bold;");
  }
  ...
  function initSherpaOnnxOfflineTtsVitsModelConfig(config, Module) {
    ...
    console.log(`[TRACED] VITS Struct: model=${config.model}, lexicon=${config.lexicon}, tokens=${config.tokens}`);
